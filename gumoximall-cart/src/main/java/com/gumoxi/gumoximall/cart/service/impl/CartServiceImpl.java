package com.gumoxi.gumoximall.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.gumoxi.gumoximall.cart.feign.ProductFeignService;
...
import com.gumoxi.gumoximall.cart.vo.SkuInfoVo;
...
public class CartServiceImpl implements CartService {
    ...
    private final String CART_PREFIX = "gumoximall:cart:";
    @Autowired
    ...
    public CartItem addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(res)) {
            ...
            CompletableFuture<Void> getSkuInfoTask = CompletableFuture.runAsync(() -> {
                ...
                cartItem.setTotalPrice(skuInfoVo.getPrice());
            }, executor);
            ...
            // 将商品信息放入到购物车中
            String itemInfo = JSON.toJSONString(cartItem);
            cartOps.put(skuId.toString(), itemInfo);
            return cartItem;
        } else {
            // 购物车有此商品，修改数量即可
    ...
    public Cart getCart() throws ExecutionException, InterruptedException {
        ...
        if (userInfoTo.getUserId() != null) {
            ...
            //3、获取登录后的购物车的数据【包括合并过来的临时购物车的数据，和登录后购物车的数据】
    ...
    @Override
    public List<CartItem> getCurrentMemberCartItems() {
        UserInfoTo userInfoTo = CartInterceptor.threadLocal.get();
        if (userInfoTo.getUserId() == null) {
            return null;
        } else {
            ...
            List<CartItem> collect = cartItems.stream().filter(item ->
                ...
                // TODO 更新为最新价格
                item.setPrice(new BigDecimal(price.get("data").toString()));
                return item;
