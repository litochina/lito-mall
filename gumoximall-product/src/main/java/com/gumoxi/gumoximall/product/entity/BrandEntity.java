package com.gumoxi.gumoximall.product.entity;
...
import com.gumoxi.gumoximall.common.valid.ListValue;
...
public class BrandEntity implements Serializable {
	...
	@Min(value = 0, message = "排序必须大于浓郁0", groups = {AddGroup.class, UpdateGroup.class})
